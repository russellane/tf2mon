    ...
    def _load_fkeys(self):
        ...
        return [
            ...
            FKey(
                ...
                handler=lambda m: self.monitor.toggle_debug_flag(),
            ),
            FKey(
                cmd="TOGGLE-TAUNT",
                game_key="F3",
                ...
                handler=lambda m: self.monitor.toggle_taunt_flag(),
            ),
            FKey(
                cmd="TOGGLE-KD",
                game_key="F4",
                ...
                handler=lambda m: self.monitor.toggle_show_kd(),
            ),
            FKey(
                ...
                handler=lambda m: self.monitor.toggle_user_panel(),
            ),
            FKey(
                cmd="SWITCH-MY-TEAM",
                game_key="F6",
                ...
                handler=lambda m: self.monitor.join_other_team(),
            ),
            FKey(
                cmd="TOGGLE-SORT",
                game_key="F7",
                ...
                handler=lambda m: self.monitor.toggle_sort_order(),
            ),
            FKey(
                ...
                handler=lambda m: self.monitor.toggle_log_location(),
            ),
            FKey(
                ...
                handler=lambda m: self.monitor.toggle_grid_layout(),
            ),
            FKey(
                cmd="SINGLE-STEP",
                game_key="KP_DEL",
